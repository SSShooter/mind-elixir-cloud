...
const messages = {
  en: {
    misc: {
      ...
      completed: "Completed, window will close soon",
      connectionFailed: "Connection failed, please retry",
      checkDesktopApp:
        "Failed to connect to desktop app, please check if the app is running",
    },
    menu: {
      public: "Public",
      folder: "Folder",
  ...
  cn: {
    misc: {
      ...
      ensureDesktopRunning: "请确保桌面应用已启动并在等待连接",
      ...
      completed: "已完成，窗口即将关闭",
      connectionFailed: "连接失败，请重试",
      checkDesktopApp: "连接桌面应用失败，请检查应用是否正在运行",
    },
    menu: {
      public: "公开",
      folder: "文件夹",
  ...
  ja: {
    misc: {
      ...
      ensureDesktopRunning:
        "デスクトップアプリが起動して接続を待機していることを確認してください",
      ...
      completed: "完了、ウィンドウは間もなく閉じます",
      connectionFailed: "接続に失敗しました、再試行してください",
      checkDesktopApp:
        "デスクトップアプリへの接続に失敗しました、アプリが実行中か確認してください",
    },
    menu: {
      public: "公開",
      folder: "フォルダ",
